...
export default function FormComponentsRestest3({ initialStep, initialOsdate }) {
  ...
  const handleSubmit = async (event) => {
    if (validateStep(step)) {
      ...
      // const redirectTo = `/lp/servicestep/input/career/thanks` // ここにHubSpotでコピーしたリダイレクトURLを使用しても構いません
