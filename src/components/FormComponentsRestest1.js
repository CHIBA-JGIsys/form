...
export default function FormComponentsRestest1({ initialStep, initialOsdate }) {
  ...
  const handleSubmit = async (event) => {
    if (validateStep(step)) {
      ...
      const redirectTo = `/lp/servicestep/input/student` // ここにHubSpotでコピーしたリダイレクトURLを使用しても構いません
