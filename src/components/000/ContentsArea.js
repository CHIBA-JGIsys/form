    ...
    <>
      <div className={styles.contentsArea}>
        ...
        <p className={styles.contents}>
          <img
            src={imageUrl1}
            alt='徹底した自己分析で自分”だけ”の魅力が分かる まずは初回カウンセリング面談の60分で、徹底的にあなたにヒアリングします。あなたの過去（小・中・高・大）の印象的な経験を深ぼる中で、あなたが大切にしてる価値観や考え方、自分は当たり前だと思っているけど、本当は強みになる要素などを言語化していきます。自己分析を1人進めるのはどうしても難しいので、irodasSALONではプロの就活アドバイザーが徹底してカウンセリングさせていただきます。'
          />
        </p>
      </div>
      {props.section}
