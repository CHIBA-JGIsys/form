...
const ThanksPage = () => {
  ...
  useEffect(() => {
    ...
    if (year === '24年3月' && liberalartsscience === '文系') {
      setIframeUrl(
        'https://meetings.hubspot.com/irodassalon/all24202207?embed=true'
      )
    } else if (year === '25年3月' && liberalartsscience === '文系') {
      setIframeUrl(
        'https://meetings.hubspot.com/irodassalon/all25202305?embed=true'
      )
    } else if (year === '26年3月' && liberalartsscience === '文系') {
      setIframeUrl(
        'https://meetings.hubspot.com/irodassalon/all24se202207?embed=true'
      )
