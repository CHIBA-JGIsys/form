            ...
            <div className={styles.tahnkscontainer}>
              ...
              <div className={styles.front}>
                <img
                  ...
                  src={url('/img/thankspageline2025front.png')}
                  alt=''
                />
                <img
                  className={styles.imgMov}
                  src={url('/img/thankspageline2025frontmov.png')}
                  alt=''
                />
              </div>
              <div className={styles.button}>
                <a href='https://works.do/R/ti/p/irodassalon.marketing25@irodascoltd'>
                  <img
                    className={styles.imgPC}
