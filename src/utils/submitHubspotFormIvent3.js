...
export async function submitGoogleform3(data) {
...
export async function submitHubspotFormIvent3(formData, router) {
  ...
  try {
      ...
      await submitGoogleform3(requestData)
    console.log('Form submitted successfully')
      const redirectTo = `/member/input/career/thanks` // ここにHubSpotでコピーしたリダイレクトURLを使用しても構いません
